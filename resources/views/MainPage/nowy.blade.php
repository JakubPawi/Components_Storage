                    ...
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <form action="{{ route ('store') }}" method="POST" id="contactForm" data-sb-form-api-token="API_TOKEN">
                            ...
                            <div class="form-floating mb-3">
                                <input value="{{old('name')}}" class="form-control" id="name" name="name" type="text" placeholder="Nazwa komponentu" data-sb-validations="required" />
                        ...
                        @endif
                            <!-- Kod input-->
                            <div class="form-floating mb-3">
                                <input value="{{old('code')}}" class="form-control" id="code" name="code" type="text" placeholder="Kod komponentu" data-sb-validations="required" />
                        ...
                        @endif
                            <!-- Ilosc input-->
                            <div class="form-floating mb-3">
                                <input value="{{old('que')}}" class="form-control" id="que" name="que" type="text" placeholder="Ilosc komponentu" data-sb-validations="required" />
                        ...
                        @endif
                            <!-- Lokacja input-->
                            <div class="form-floating mb-3">
                                <input value="{{old('location')}}" class="form-control" id="location" name="location" type="text" placeholder="Lokacja komponentu" data-sb-validations="required" />
